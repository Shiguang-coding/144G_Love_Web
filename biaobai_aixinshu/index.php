...
<title>爱心树表白网页_表白网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">爱心树表白网页</h2>
            <h3 class="animate-box"><a href="../web.php?id=88emDpV" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	  ...
	  <div class="col-md-12">
        <div class="form-group">
          	<div id="fh5co-subscribe" class="input-append date form_datetime" data-picker-position="bottom-left">
            	<input id="con5" name="con5" type="text" class="form-control" placeholder="请输入相识日期">
	...
	<script>
        function shuru(){
            ...
            con2.value='老鼠';
            con3.value='大米';
            con4.value='你不开心的时候，我陪你，你哭泣的时候，我陪你，你心情很不爽的时候，我陪你，你不想回家的时候，我陪你，无论怎样，我都陪你，只因为你是我最爱的人，你就是我的音乐，你给我带来好听的音符。你是我的全部，你给我生命带来了色彩。';
            con5.value='2017-01-01';
            con6.value='http://music.163.com/song/media/outer/url?id=5257439.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
