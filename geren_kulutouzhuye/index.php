...
<title>骷髅头个人主页_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">骷髅头个人主页</h2>
            <h3 class="animate-box"><a href="../web.php?id=FQa48Ta" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="请输入主页名称">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group animate-box">
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-12 animate-box">
					<input id="con3" name="con3" type="text" class="form-control" placeholder="请输入按钮一名称">
				</div>
				<div class="col-md-8 col-sm-8 col-xs-12 animate-box">
					<input id="con4" name="con4" type="text" class="form-control" placeholder="请输入按钮一链接">
				</div>
			</div>
		</div>
      </div>
	  <div class="col-md-12">
        <div class="form-group animate-box">
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-12 animate-box">
					<input id="con5" name="con5" type="text" class="form-control" placeholder="请输入按钮二名称">
				</div>
				<div class="col-md-8 col-sm-8 col-xs-12 animate-box">
					<input id="con6" name="con6" type="text" class="form-control" placeholder="请输入按钮二链接">
				</div>
			</div>
		</div>
      </div>
	  <div class="col-md-12">
        <div class="form-group animate-box">
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-12 animate-box">
					<input id="con7" name="con7" type="text" class="form-control" placeholder="请输入按钮三名称">
				</div>
				<div class="col-md-8 col-sm-8 col-xs-12 animate-box">
					<input id="con8" name="con8" type="text" class="form-control" placeholder="请输入按钮三链接">
				</div>
			</div>
		</div>
      </div>
	  <div class="col-md-12">
        <div class="form-group animate-box">
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-12 animate-box">
					<input id="con9" name="con9" type="text" class="form-control" placeholder="请输入按钮四名称">
				</div>
				<div class="col-md-8 col-sm-8 col-xs-12 animate-box">
					<input id="con10" name="con10" type="text" class="form-control" placeholder="请输入按钮四链接">
				</div>
			</div>
		</div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con11" name="con11" type="text" class="form-control" placeholder="请输您的ＱＱ号 &#40;按钮五为联系按钮&#41;">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <textarea id="con12" name="con12" type="text" class="form-control textarea" rows="3" placeholder="请输入滚动公告"></textarea>
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con13" name="con13" type="text" class="form-control" placeholder="请输入背景音乐URL地址">
	...
	<script>
        function shuru(){
            ...
            con2.value='骷髅头个人主页';
            con3.value='我的首页';
            con4.value='https://www.shiguang666.eu.org';
            con5.value='我的博客';
            con6.value='http://blog.shiguang666.eu.org';
            con7.value='我的导航';
            con8.value='http://nav.shiguang666.eu.org';
            con9.value='个人业务';
            con10.value='https://www.shiguang666.eu.org';
            con11.value='1265069519';
            con12.value='公告：時光网页制作是一款全自动在线网页制作工具，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。';
            con13.value='http://music.163.com/song/media/outer/url?id=1974443814.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
