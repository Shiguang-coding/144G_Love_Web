...
<title>简约星空表白网页_表白网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">简约星空表白网页</h2>
            <h3 class="animate-box"><a href="../web.php?id=R1dcpXW" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con1.value='简约星空表白网页';
            con2.value='这片星空属于我和你，我爱你！';
			      con3.value='http://music.163.com/song/media/outer/url?id=5238992.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
