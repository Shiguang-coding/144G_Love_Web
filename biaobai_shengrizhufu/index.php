...
<title>生日祝福网页_表白网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">生日祝福网页</h2>
            <h3 class="animate-box"><a href="../web.php?id=zj0YBnM" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <textarea id="con3" name="con3" type="text" class="form-control textarea" rows="5" placeholder="请输入第一段话"></textarea>
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <textarea id="con4" name="con4" type="text" class="form-control textarea" rows="5" placeholder="请输入第二段话"></textarea>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="请输入文章底部信息">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con1.value='生日祝福网页';
            con2.value='亲爱的宝贝：';
            con3.value='在你生日到来之际，我将快乐的音符，作为礼物送给你，愿您拥有365个美丽的日子，衷心地祝福你，生日快乐！在此诚挚地献上我的三个祝愿：一愿你身体健康；二愿你幸福快乐；三愿你万事如意！';
            con4.value='送你一个生日蛋糕，祝你生日快乐！第一层，体贴！第二层，关怀！第三层，浪漫！第四层，温馨！中间夹层，甜蜜！祝你天天都有一份好心情！';
            con5.value='老鼠 ★ 大米';
            con6.value='http://music.163.com/song/media/outer/url?id=1433496995.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
