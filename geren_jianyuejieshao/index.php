...
<title>简约个人介绍页_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">简约个人介绍页</h2>
            <h3 class="animate-box"><a href="../web.php?id=d9f8p2V" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con3.value='時光';
            con4.value='時光主页 | WWW.shiguang666.eu.org';
