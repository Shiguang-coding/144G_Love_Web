...
<title>典雅业务网_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">典雅业务网</h2>
            <h3 class="animate-box"><a href="../web.php?id=sqQMQcj" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
	  ...
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con47" name="con47" type="text" class="form-control" placeholder="请输入顶部标题">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con48" name="con48" type="text" class="form-control" placeholder="请输入顶部副标题">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con49" name="con49" type="text" class="form-control" placeholder="请输入业务提示">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con51" name="con51" type="text" class="form-control" placeholder="请输入发货时间">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con44.value='0.00';
            con46.value='典雅业务网';
            con47.value='典雅业务网 - 旗舰店';
            con48.value='旗 舰 店 业 务 及 价 格 表';
            con49.value='本站拒绝还价丶请您不要自讨没趣找茬';
            con50.value='1265069519';
			      con51.value='秒发';
            con52.value='Copyright © 2024 時光 版权所有 运行商：時光网页制作';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
