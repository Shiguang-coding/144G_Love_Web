...
<title>魔幻粒子表白网页_表白网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">魔幻粒子表白网页</h2>
            <h3 class="animate-box"><a href="../web.php?id=8t0kfY9" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入跳转链接">
        </div>
	  </div>
      <div class="col-md-12">
          <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con1.value='魔幻粒子表白网页';
            con2.value='亲爱的|老婆大人|你即将成为|全世界|最幸福|的妻子。：';
