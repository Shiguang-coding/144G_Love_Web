...
<title>简约个人收徒网_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">简约个人收徒网</h2>
            <h3 class="animate-box"><a href="../web.php?id=dtwe0bi" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <textarea id="con2" name="con2" type="text" class="form-control textarea" rows="4" placeholder="请输入第一页介绍"></textarea>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <textarea id="con3" name="con3" type="text" class="form-control textarea" rows="4" placeholder="请输入第二页介绍"></textarea>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <textarea id="con4" name="con4" type="text" class="form-control textarea" rows="4" placeholder="请输入第三页介绍"></textarea>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <textarea id="con5" name="con5" type="text" class="form-control textarea" rows="4" placeholder="请输入第四页介绍"></textarea>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <textarea id="con6" name="con6" type="text" class="form-control textarea" rows="4" placeholder="请输入第五页介绍"></textarea>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <textarea id="con7" name="con7" type="text" class="form-control textarea" rows="4" placeholder="请输入第六页介绍"></textarea>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <textarea id="con8" name="con8" type="text" class="form-control textarea" rows="4" placeholder="请输入第七页介绍"></textarea>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con9" name="con9" type="text" class="form-control" placeholder="请输您的ＱＱ号">
        </div>
      </div>
      <div class="col-md-12">
          <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con1.value='简约个人收徒网';
            con2.value='现招收终身学徒，欢迎来自全国各地的网络爱好者加入带你学习各种网络技术，带你装逼，带你做网赚。';
            con3.value='一名网络爱好者，90后，高中文化，略帅...爱装逼，爱赚钱，有梦想，高拼搏，敢吃苦！';
            con4.value='全部技术、软件、教程、源码、等等，各种最新前端技术，包教包会，应有尽有，让你告别网络菜鸟。';
            con5.value='找个师傅容易，找个好师傅难，我不想说我自己有多么的好！但我能给我徒弟保证我会的技术我会毫无保留的教给你，做到有问必答。';
            con6.value='徒弟级别：终身学徒100元，私人学徒300元，至尊学徒500元。每种级别有每种级别的教学方式、教学内容。你诚心来学，我用心来教！每天进步一点点，无形跨出一大步。';
            con7.value='网络墙头草，这边假惺惺，背后捅你一刀的人。卑鄙小人，学了技术去害人的，不务正业，不利于社会的人。总是有什么事都找我处理的人。如果你不符合要求，就不用来拜师了！';
            con8.value='你还在等什么？赶快联系加入我们吧！';
            con9.value='1265069519';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
