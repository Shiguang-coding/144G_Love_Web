...
<title>粒子特效黑客主页_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">粒子特效黑客主页</h2>
            <h3 class="animate-box"><a href="../web.php?id=J44W3c1" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="顶部第一行文字">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="顶部第二行文字">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="顶部第三行文字">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con6" name="con6" type="text" class="form-control" placeholder="顶部第四行文字">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <textarea id="con7" name="con7" type="text" class="form-control textarea" rows="5" placeholder="请输入个人简历"></textarea>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con8" name="con8" type="text" class="form-control" placeholder="请输您的ＱＱ号">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con3.value='每个黑客都有一段向往的爱情';
            con4.value='为了追一个女孩，我想入侵此域名高调对她表白！';
            con5.value='只不过，这一切就是一场梦，梦醒后，我才知道黑客是不需要爱情的！';
            con6.value='By：時光';
            con7.value='黑客，不需要爱情！';
            con8.value='1265069519';
            con9.value='http://music.163.com/song/media/outer/url?id=1825750472.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
