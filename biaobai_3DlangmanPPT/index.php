...
<title>3D浪漫表白PPT_表白网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">3D浪漫表白PPT</h2>
            <h3 class="animate-box"><a href="../web.php?id=4c9FQ59" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
	  ...
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="请输入操控提示内容">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入第一页内容">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="请输入第二页内容">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="请输入第三页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con6" name="con6" type="text" class="form-control" placeholder="请输入第四页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con7" name="con7" type="text" class="form-control" placeholder="请输入第五页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con8" name="con8" type="text" class="form-control" placeholder="请输入第六页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con9" name="con9" type="text" class="form-control" placeholder="请输入第七页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con10" name="con10" type="text" class="form-control" placeholder="请输入第八页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con11" name="con11" type="text" class="form-control" placeholder="请输入第九页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con12" name="con12" type="text" class="form-control" placeholder="请输入第十页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con13" name="con13" type="text" class="form-control" placeholder="请输入第十一页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con14" name="con14" type="text" class="form-control" placeholder="请输入第十二页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con15" name="con15" type="text" class="form-control" placeholder="背景大图URL地址">
	...
	<script>
      function shuru(){
            ...
            con1.value='3D浪漫表白PPT';
            con2.value='使用 “空格键” 或者 “↑ ↓ ← →” 操控哦！';
            con3.value='此网页送给我最心爱的人某某某，认真聆听我的内心独白哦！';
            con4.value='你是一个活泼 可爱的女孩 很善良，天真浪漫，虽然我们接触的时间不长，只有短短几个月，却让我感觉是那么的熟悉与开心';
            con5.value='难以忘记初次见面的感觉，我被一种神奇的东西吸引，那时我的心七上八下的，我相信这就是一见钟情';
            con6.value='那以后，你的一个微笑，一个表情，都深深的留在了我的心里';
            con7.value='我一次次的更加确定，你就是我一直等待的人';
            con8.value='只要你愿意，我可以陪你去任何你想去的地方我可以陪你去吃任何你喜欢吃的东西，我可以陪你去做你想做的事。';
            con9.value='总之你愿意，我会一直陪着你。';
            con10.value='某某某，能够遇见你 对我来说是最大的幸福';
            con11.value='无论何时我都会支持你，相信你，保护你！你开心我便开心，你不高兴我也会很难过！';
            con12.value='在以后的日子里，也许有很的多无法确定但唯一可以确定的是，我会一直珍惜你';
            con13.value='我会努力让你成为世上第二幸福的人，因为';
            con14.value='爱上你是我最大的幸福';
            con15.value='https://img2.imgtp.com/2024/05/29/d4kSb5if.jpg';
            con16.value='http://music.163.com/song/media/outer/url?id=27965305.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
