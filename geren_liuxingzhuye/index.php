...
<title>流星个人主页_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">流星个人主页</h2>
            <h3 class="animate-box"><a href="../web.php?id=zfThHlC" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="请输入首页链接">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="请输您的ＱＱ号">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <textarea id="con6" name="con6" type="text" class="form-control textarea" rows="5" placeholder="请输入提示公告"></textarea>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con7" name="con7" type="text" class="form-control" placeholder="请输入底部标题">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            var con8=document.getElementById('con8');
            con1.value='流星个人主页';
            con2.value='https://img2.imgtp.com/2024/05/29/Cvrgca4k.ico';
            con3.value='時光网页制作';
            con4.value='https://www.shiguang666.eu.org';
            con5.value='1265069519';
            con6.value='公告：時光全自动网页制作是一款全自动在线网页制作工具，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。';
            con7.value='時光';
            con8.value='Copyright ©2024 時光';
            con9.value='http://music.163.com/song/media/outer/url?id=2002677232.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
