...
<title>个人星空特效主页_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">个人星空特效主页</h2>
            <h3 class="animate-box"><a href="../web.php?id=kc6ezMn" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
	  ...
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入首页链接">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="请输您的ＱＱ号">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <textarea id="con5" name="con5" type="text" class="form-control textarea" rows="5" placeholder="请输入提示公告"></textarea>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con6" name="con6" type="text" class="form-control" placeholder="请输入文章标题">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con7" name="con7" type="text" class="form-control" placeholder="请输入文章内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con8" name="con8" type="text" class="form-control" placeholder="请输入底部版权">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con1.value='時光网页制作';
            con2.value='个人星空特效主页';
            con3.value='http://www.shiguang666.eu.org';
            con4.value='1265069519';
            con5.value='公告：時光网页制作是一款全自动在线网页制作工具，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。';
            con6.value='星空';
            con7.value='星空，浮现在那落寞的黑夜， 他们在向这一片土地招手的那一刻。是温暖，还有希望。它们点缀那片我们的天空， 不知不觉， 这世界黑得温馨。';
            con8.value='Copyright ©2024 時光';
            con9.value='http://music.163.com/song/media/outer/url?id=1911905620.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
