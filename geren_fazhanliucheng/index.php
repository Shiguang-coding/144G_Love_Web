...
<title>网站发展流程页面_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">网站发展流程页面</h2>
            <h3 class="animate-box"><a href="../web.php?id=OF7i3P7" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="请输入网站名称">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入流程一">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="请输入流程二">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="请输入流程三">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con6" name="con6" type="text" class="form-control" placeholder="请输入流程四">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con7" name="con7" type="text" class="form-control" placeholder="请输入流程五">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con8" name="con8" type="text" class="form-control" placeholder="请输入流程六">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con9" name="con9" type="text" class="form-control" placeholder="网站介绍第一行">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con10" name="con10" type="text" class="form-control" placeholder="网站介绍第二行">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con11" name="con11" type="text" class="form-control" placeholder="左上官方主页地址">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con12" name="con12" type="text" class="form-control" placeholder="请输您的ＱＱ号">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con1.value='時光网页制作';
            con2.value='网站发展流程页面';
            con3.value='2024.6.1系统正式发布。';
            con4.value='2024.5.6系统完成响应式手机版。';
            con5.value='2024.4.7新增大量模板。';
            con6.value='2024.3.14可自定义图片与音乐。';
            con7.value='2024.2.20系统宣布开源。';
            con8.value='2024.1.27完成APP手机版。';
            con9.value='前路虽漫漫，時光不怕难。有求必有应，质量准过关。自是高人助，';
            con10.value='远望俯平川。天地感其善，鬼神器之酸。昔日不忘恩，今朝永为伴。';
            con11.value='http://www.shiguang666.eu.org';
            con12.value='1265069519';
            con13.value='http://music.163.com/song/media/outer/url?id=41640165.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
