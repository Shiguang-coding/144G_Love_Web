      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=wvy9MUG" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con44.value='0.00';
            con46.value='个人业务网';
            con47.value='/images/top.png';
            con48.value='/images/wx.png';
            con49.value='公告：時光网页制作是一款全自动在线网页制作工具，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。';
            con50.value='1265069519';
			      con51.value='434016829';
            con52.value='Copyright ©2024 時光';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
