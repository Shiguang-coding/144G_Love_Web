...
<title>简约橙色表白网页_表白网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">简约橙色表白网页</h2>
            <h3 class="animate-box"><a href="../web.php?id=JBC4Sf4" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="请输入第一页内容">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入第二页内容">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="请输入第三页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="请输入第四页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con6" name="con6" type="text" class="form-control" placeholder="请输入第五页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con7" name="con7" type="text" class="form-control" placeholder="请输入第六页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con8" name="con8" type="text" class="form-control" placeholder="请输入第七页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con9" name="con9" type="text" class="form-control" placeholder="请输入第八页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con10" name="con10" type="text" class="form-control" placeholder="请输入第九页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con11" name="con11" type="text" class="form-control" placeholder="请输入第十页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con12" name="con12" type="text" class="form-control" placeholder="请输入第十一页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con13" name="con13" type="text" class="form-control" placeholder="请输入第十二页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con14" name="con14" type="text" class="form-control" placeholder="请输入第十三页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con15" name="con15" type="text" class="form-control" placeholder="请输入第十四页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con16" name="con16" type="text" class="form-control" placeholder="请输入第十五页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con17" name="con17" type="text" class="form-control" placeholder="请输入第十六页内容">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con18" name="con18" type="text" class="form-control" placeholder="请输入底部信息">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con19" name="con19" type="text" class="form-control" placeholder="请输入背景音乐URL地址">
	...
	<script>
        function shuru(){
            ...
            con1.value='简约橙色表白网页';
            con2.value='亲爱的，做我女朋友吧！';
            con3.value='你是一个活泼、可爱的女孩 ，善良且天真浪漫';
            con4.value='虽然我们接触的时间不长，只有短短几个月';
            con5.value='却让我感觉是那么的熟悉与开心';
            con6.value='难以忘记初次见面的感觉，我被一种神奇的东西吸引';
            con7.value='那时我的心七上八下的，我相信这就是一见钟情';
            con8.value='那以后，你的一个微笑，一个表情，都深深的留在了我的心里';
            con9.value='我一次次的更加确定，你就是我一直等待的人';
            con10.value='只要你愿意,我可以陪你去任何你想去的地方';
            con11.value='只要你愿意,我可以陪你去吃任何你喜欢吃的东西';
            con12.value='只要你愿意,我可以陪你去做你想做的事';
            con13.value='总之你愿意，我会一直陪着你';
            con14.value='亲爱的,能够遇见你，对我来说是最大的幸福';
            con15.value='在以后的日子里，也许有很的多无法确定';
            con16.value='但唯一可以确定的是，我会一直珍惜你';
            con17.value='陪伴是最长情的告白。';
            con18.value='老鼠 & 大米。';
            con19.value='http://music.163.com/song/media/outer/url?id=1397282233.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
