      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=mRkTgvp" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
      ...
      var con11=document.getElementById('con11');
			...
			con1.value='Slide';
      con2.value='One';
      con3.value='https://img2.imgtp.com/2024/05/29/aLFtegrC.jpg';
      con4.value='Slide';
			con5.value='Two';
			con6.value='https://img2.imgtp.com/2024/05/29/j2wBwXo7.png';
			con7.value='Slide';
			con8.value='Three';
      con9.value='https://img2.imgtp.com/2024/05/29/3tXWEwI7.jpg';
      con10.value='Slide';
      con11.value='Four';
			con12.value='https://img2.imgtp.com/2024/05/29/zUil6huX.jpg';
			con13.value='Slide';
			con14.value='Five';
			con15.value='https://img2.imgtp.com/2024/05/29/Y35j9le1.jpg';
			con16.value='next';
			con17.value='http://music.163.com/song/media/outer/url?id=1397282233.mp3';
			con18.value='回忆相册PPT';
        }
    </script> 
  <!-- END #fh5co-projects -->
