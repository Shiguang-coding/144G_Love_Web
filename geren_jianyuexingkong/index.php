...
<title>简约星空主页_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">简约星空主页</h2>
            <h3 class="animate-box"><a href="../web.php?id=3NY8XHp" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
	  ...
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="请输入首页名称">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con5.value='時光个人主页，欢迎光临!';
			      con6.value='http://music.163.com/song/media/outer/url?id=29932432.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
