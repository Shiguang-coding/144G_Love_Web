...
<title>程序猿滚动介绍页_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">程序猿滚动介绍页</h2>
            <h3 class="animate-box"><a href="../web.php?id=6Z2zVBl" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="顶部第一行文字">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="顶部第二行文字">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="技术介绍一">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="技术介绍二">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con6" name="con6" type="text" class="form-control" placeholder="技术介绍三">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con7" name="con7" type="text" class="form-control" placeholder="技术介绍四">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con8" name="con8" type="text" class="form-control" placeholder="技术介绍五">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con9" name="con9" type="text" class="form-control" placeholder="技术介绍五">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con10" name="con10" type="text" class="form-control" placeholder="联系我们信息">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con11" name="con11" type="text" class="form-control" placeholder="二维码图片URL地址">
	...
	<script>
        function shuru(){
            ...
            con8.value='PHP优化';
            con9.value='精通PS';
            con10.value='QQ：1265069519';
            con11.value='https://img2.imgtp.com/2024/05/29/aMrJ3caA.png';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
