...
<title>工作室团队介绍_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">工作室团队介绍</h2>
            <h3 class="animate-box"><a href="../web.php?id=eVA5EyR" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="进入网站链接">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入团队介绍">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="请输入专业擅长">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="请输入九项全能">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con6" name="con6" type="text" class="form-control" placeholder="请输入顶尖团队">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con7" name="con7" type="text" class="form-control" placeholder="请输入团队人员一">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con8" name="con8" type="text" class="form-control" placeholder="请输入团队人员二">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con9" name="con9" type="text" class="form-control" placeholder="请输入团队人员三">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con10" name="con10" type="text" class="form-control" placeholder="请输入团队人员四">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con11" name="con11" type="text" class="form-control" placeholder="请输入团队人员五">
        </div>
      </div>
      <div class="col-md-12">
          <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con1.value='工作室团队介绍';
            con2.value='http://www.shiguang666.eu.org';
            con3.value='我们是来自全国各地的建站爱好者，遥遥领先，独占鳌头';
            con4.value='充分利用各位成员的特长。融合进入一个团体，各种前端技术，应有尽有';
            con5.value='全新更改，更加出色的团队';
            con6.value='小彬网络小组全球化视野，素质领先同类团队，源于安全，深度开发';
            con7.value='团队核心：马斯克';
            con8.value='团队副总管：雷军';
            con9.value='团队创始人：時光';
            con10.value='联合创始人：詹姆斯';
            con11.value='敬请期待..';
        }
    </script> 
  <!-- END #fh5co-projects -->
