...
<title>个人黑客主页_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">个人黑客主页</h2>
            <h3 class="animate-box"><a href="../web.php?id=xwf3WhU" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
