...
<title>个性引导页_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">个性引导页</h2>
            <h3 class="animate-box"><a href="../web.php?id=iO54jWt" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
	  ...
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="请输入引导内容">
		  <span class="help-block text-center">（注意：每页引导内容请使用：&quot;|&quot; 符号隔开，建议直接复制符号，避免出错。）</span>
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入头像图片URL地址">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="请输入主页名称">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="请输入主页签名">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con6" name="con6" type="text" class="form-control" placeholder="请输入首页链接">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con7" name="con7" type="text" class="form-control" placeholder="请输您的ＱＱ号">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <textarea id="con8" name="con8" type="text" class="form-control textarea" rows="5" placeholder="请输入提示公告"></textarea>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con9" name="con9" type="text" class="form-control" placeholder="请输入底部版权">
        </div>
      </div>
      <div class="col-md-12">
          <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con1.value='時光网页制作';
            con2.value='欢迎来到|在线网页|制作系统|我是時光|我为自己|代言';
            con3.value='https://img2.imgtp.com/2024/05/29/Eo4j2ISh.jpg';
            con4.value='个性引导页';
            con5.value='時光网页制作，国内顶尖自动化网页制作系统';
            con6.value='http://www.shiguang666.eu.org';
            con7.value='1265069519';
            con8.value='公告：時光网页制作是一款全自动在线网页制作工具，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。';
            con9.value='Copyright ©2024 時光';
