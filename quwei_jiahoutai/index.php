...
<title>假后台恶搞网页_网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">假后台恶搞网页</h2>
            <h3 class="animate-box"><a href="../web.php?id=RicTkdd" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con1" name="con1" type="text" class="form-control" placeholder="请输入后台标题">
		  <span class="help-block text-center">（注意：此网站是个假后台的恶搞网站，预览的时候请注意别吓着了，有声音。手机访问输入账号密码后是啪啪啪声音，老司机秒懂。）</span>
		</div>
      </div>
      <div class="col-md-12">
          <div class="form-group">
