...
<title>MV表白网页_表白网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">MV表白网页</h2>
            <h3 class="animate-box"><a href="../web.php?id=n4UTtF9" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
	  ...
	  <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con2" name="con2" type="text" class="form-control" placeholder="请输入图片URL地址">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入鼠标跟随文字">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="请输入第一行文字">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="请输入第二行文字">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con6" name="con6" type="text" class="form-control" placeholder="请输入第三行文字">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con7" name="con7" type="text" class="form-control" placeholder="请输入第四行文字">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <textarea id="con8" name="con8" type="text" class="form-control textarea" rows="5" placeholder="请输入表白内容"></textarea>
        </div>
      </div>
      <div class="col-md-12">
          <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con1.value='MV表白网页';
            con2.value='https://img2.imgtp.com/2024/05/29/RH7Rmcvc.png';
            con3.value='我爱你';
            con4.value='某某某，在未来的日子里，也许什么都无法确定，但唯一可以确定的是，我爱的人是你';
            con5.value='某某某，我会珍惜和你在一起的每一刻，每一分，每一秒';
            con6.value='某某某，我喜欢你，真的很喜欢，就像向日葵如此依赖太阳一般的喜欢';
            con7.value='那么，你能答应，和我永远在一起吗？';
            con8.value='某某某，我只想给你一颗真心，我只想努力去疼爱你，我只想一辈子陪伴你，我想说 我爱你。表达出我自己的意思，不想憋在心里，我想要和你一起慢慢变老，我不要短暂的温存，只要你一世的陪伴';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
