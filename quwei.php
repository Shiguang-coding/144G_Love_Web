...
<title>趣味网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<!--Baidu display logo-->
<div class="dnone"><img width="121" src="images/nav-quwei.jpg" alt="logo" /></div>
...
<div id="fh5co-page">
    ...
    <div class="container">
      <nav role="navigation">
        <ul class="pull-left left-menu">
          ...
          <li class="active"><a href="quwei.php">趣味网页</a></li>
        </ul>
  ...
  <!-- #fh5co-header -->
  <section id="fh5co-hero" class="no-js-fullheight" style="background-image: url(images/nav-quwei.jpg);" data-next="yes">
    <div class="fh5co-overlay"></div>
    <div class="container">
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">趣味网页制作</h2>
            <h3 class="animate-box">Interest web page making</h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    <div class="container">
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('quwei','quwei_tiyanxidu',$viptem)) echo '<a class="vippng" href="quwei_tiyanxidu/" target="_blank"></a>'; ?><a href="quwei_tiyanxidu/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="quwei_tiyanxidu/logo.png" alt="真实体验幻觉网页" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>真实体验幻觉网页</h2>
            <p>网页制作</p>
          </div>
          </a> </div>
		  <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('quwei','quwei_qqjiahaoyou',$viptem)) echo '<a class="vippng" href="quwei_qqjiahaoyou/" target="_blank"></a>'; ?><a href="quwei_qqjiahaoyou/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="quwei_qqjiahaoyou/logo.png" alt="音乐在线播放系统" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>自定义生成@加好友</h2>
            <p>网页制作</p>
          </div>
          </a> </div>
        <div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('quwei','quwei_zaixianbofang',$viptem)) echo '<a class="vippng" href="quwei_zaixianbofang/" target="_blank"></a>'; ?><a href="quwei_zaixianbofang/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="quwei_zaixianbofang/logo.png" alt="音乐在线播放系统" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>音乐在线播放系统</h2>
            <p>网页制作</p>
          </div>
          </a> </div>
		<div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('quwei','quwei_vipshipinjiexi',$viptem)) echo '<a class="vippng" href="quwei_vipshipinjiexi/" target="_blank"></a>'; ?><a href="quwei_vipshipinjiexi/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="quwei_vipshipinjiexi/logo.png" alt="VIP视频解析网站" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>VIP视频解析网站</h2>
            <p>网页制作</p>
          </div>
          </a> </div>
		<div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('quwei','quwei_jiahoutai',$viptem)) echo '<a class="vippng" href="quwei_jiahoutai/" target="_blank"></a>'; ?><a href="quwei_jiahoutai/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="quwei_jiahoutai/logo.png" alt="假后台恶搞网页" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>假后台恶搞网页</h2>
            <p>网页制作</p>
          </div>
          </a> </div>
		<div class="col-md-4 col-sm-6 col-xs-6 animate-box"><?php if(pdviptem('quwei','quwei_xinnianzhufu',$viptem)) echo '<a class="vippng" href="quwei_xinnianzhufu/" target="_blank"></a>'; ?><a href="quwei_xinnianzhufu/" class="fh5co-project-item" target="_blank"> <img src="images/loading.png" data-original="quwei_xinnianzhufu/logo.png" alt="新年祝福网页" class="img-responsive lazy">
          <div class="fh5co-text">
            <h2>新年祝福网页</h2>
            <p>网页制作</p>
          </div>
