...
<title>粉色飘叶个人主页_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">粉色飘叶个人主页</h2>
            <h3 class="animate-box"><a href="../web.php?id=ZASGwR7" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="请输入主页签名一">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="请输入主页签名二">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con3.value='時光个人主页';
            con4.value='時光个人主页，欢迎光临!';
            con5.value='用心分享快乐';
            con6.value='1265069519';
            con7.value='http://music.163.com/song/media/outer/url?id=500665346.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
