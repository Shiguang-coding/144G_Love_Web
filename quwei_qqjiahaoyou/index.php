...
<title>自定义生成@加好友_网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">自定义生成@加好友</h2>
            <h3 class="animate-box"><a href="../web.php?id=8wdi4Bo" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	  ...
	  <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con1" name="con1" type="text" class="form-control" placeholder="请输入二维码URL地址">
          </div>
		  <span class="help-block text-center">（说明：二维码请到手机QQ获取，获取后将二维码图片地址输入即可，若不会获取二维码请<a href="http://jingyan.baidu.com/article/fec7a1e5eaa53e1191b4e778.html" target="_blank"> 点击这里 </a>查看教程。）</span>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="请输您的ＱＱ号">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入自定义内容">
		  <span class="help-block text-center">（注意：禁止使用违反QQ空间协议的诱导内容，如：”点击“、”领取“、”加我“、”免费“等等，发现封IP永久。）</span>
        </div>
      </div>
      <div class="col-md-12">
          <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con1.value='https://qm.qq.com/q/20lWrwzUBy';
            con2.value='1265069519';
            con3.value='@時光';
        }
    </script> 
  <!-- END #fh5co-projects -->
