...
<title>火焰字引导页_个人网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">火焰字引导页</h2>
            <h3 class="animate-box"><a href="../web.php?id=IrOYeB3" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="请输入火焰字">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入您的QQ号">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con4" name="con4" type="text" class="form-control" placeholder="请输入背景音乐URL地址">
	...
	<script>
        function shuru(){
            ...
            con1.value='火焰字引导页';
            con2.value='時光网页制作';
            con3.value='1265069519';
			      con4.value='http://music.163.com/song/media/outer/url?id=1422212205.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
