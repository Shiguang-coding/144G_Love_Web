...
<title>新年祝福网页_网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">新年祝福网页</h2>
            <h3 class="animate-box"><a href="../web.php?id=OJyzpeo" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="祝福人名字/别名">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入祝福语">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="下方第一句话">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="下方第二句话">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con6" name="con6" type="text" class="form-control" placeholder="请输入底部版权">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            <input id="con7" name="con7" type="text" class="form-control" placeholder="请输入背景音乐URL地址">
	...
	<script>
        function shuru(){
            ...
            con1.value='新年祝福网页';
            con2.value='時光';
            con3.value='祝您2025年新年快乐！';
            con4.value='新的开始，新的希望；新的一年，新的梦想；新的阳光，新的篇章!';
            con5.value='新的一年您一定会更加顺利！更加美满！';
            con6.value='Copyright ©2024 時光';
            con7.value='http://music.163.com/song/media/outer/url?id=396696.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
