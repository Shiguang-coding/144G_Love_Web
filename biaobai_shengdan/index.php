...
<title>圣诞祝福网页_表白网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">圣诞祝福网页</h2>
            <h3 class="animate-box"><a href="../web.php?id=40RTJ4a" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
	  ...
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入第一句祝福语">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="请输入第二句祝福语">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con1.value='圣诞祝福网页';
            con2.value='https://img2.imgtp.com/2024/05/29/Eo4j2ISh.jpg';
            con3.value='圣诞节快乐';
            con4.value='祝你享尽圣诞佳节的快乐和圣诞的礼品。';
            con5.value='1265069519';
            con6.value='http://music.163.com/song/media/outer/url?id=22509038.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
