...
<title>VIP视频解析网站_网页制作_<?php echo htmlspecialchars(urldecode($title)); ?></title>
...
<div id="fh5co-page">
      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            <h2 class="animate-box">VIP视频解析网站</h2>
            <h3 class="animate-box"><a href="../web.php?id=MqXOmYZ" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
    ...
    <form method="post" action="../result.php">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <input id="con2" name="con2" type="text" class="form-control" placeholder="请输入顶部标题">
        </div>
      </div>
      <div class="col-md-12">
        <div class="form-group">
          <input id="con3" name="con3" type="text" class="form-control" placeholder="请输入网站公告">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con4" name="con4" type="text" class="form-control" placeholder="请输客服ＱＱ号">
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
          <input id="con5" name="con5" type="text" class="form-control" placeholder="请输入底部版权">
        </div>
      </div>
      <div class="col-md-12">
          <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con1.value='時光网页制作';
            con2.value='VIP视频解析网站。';
            con3.value='公告：接口更新，基本能免费解析全网VIP收费视频。';
            con4.value='1265069519';
			      con5.value='Copyright ©2024 時光';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
